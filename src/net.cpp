...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "B24coin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"b24coin.com", "46.166.165.105"},
    {"b24coin.com", "188.214.128.129"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. B24coin is probably already running."), addrBind.ToString().c_str());
        else
